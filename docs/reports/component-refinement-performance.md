...
| --- | --- | ---: | ---: | --- | --- |
| Complete neutral component CSS compatibility bundle | — | 579342 | 78035 | None | observed |
| Complete progressive-enhancement compatibility runtime | — | 118114 | 22912 | None | observed |
| Neutral web token target | — | 409048 | 50181 | None | observed |
...
| Largest dependency-closed Storytelling install slice | artist-card | 197393 | 27795 | None | observed |
...
| Surface | Largest component/asset | Raw bytes | Gzip bytes | Target rule | Result |
| --- | --- | ---: | ---: | --- | --- |
| Shopify theme token asset | — | 409208 | 50227 | None | observed |
| Largest Shopify local CSS asset (inventory, including compatibility files) | tokens.css | 409208 | 50227 | 100000 rawBytes; advisory | advisory-overage |
...
- `platforms/shopify/assets/tokens.css`: 409208 raw bytes, 50227 gzip bytes.
