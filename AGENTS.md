...
Component-scoped tokens are allowed only when a contract exposes them as public customization API or a reusable component-level design decision. Do not create a token for every private CSS variable.
