...
export function staticSwatchBindingError(renderer, kind, tokens, category) {
  if (!['MarketingStudio', 'BlogStudio', 'StorytellingStudio', 'PagesStudio', 'ReviewsStudio', 'CartStudio', 'GlobalStudio', 'SectionsStudio'].includes(renderer) || kind !== 'token-swatch') return null;
