...
Resolved palette decision (2026-09-12): the owner selected A. Coming Soon uses
fixed white on-media text in both themes with the existing black gradient;
public tokens expose text, tint and opacity. See ADR 0392 and
`docs/reports/2026-09-12-coming-soon-palette-checkpoint.md`.
...
### Image with Text on-media palette (resolved 2026-09-13)

The owner selected A. ADR 0398 gives Overlay white on-media text and the existing
