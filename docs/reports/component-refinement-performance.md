...
| --- | --- | ---: | ---: | --- | --- |
| Complete neutral component CSS compatibility bundle | — | 586105 | 78742 | None | observed |
| Complete progressive-enhancement compatibility runtime | — | 118114 | 22912 | None | observed |
| Neutral web token target | — | 483433 | 59059 | None | observed |
...
| Largest dependency-closed Ceramics install slice | commission-form | 248070 | 34026 | None | observed |
...
| Surface | Largest component/asset | Raw bytes | Gzip bytes | Target rule | Result |
| --- | --- | ---: | ---: | --- | --- |
| Shopify theme token asset | — | 483593 | 59105 | None | observed |
| Largest Shopify local CSS asset (inventory, including compatibility files) | tokens.css | 483593 | 59105 | 100000 rawBytes; advisory | advisory-overage |
...
- `platforms/shopify/assets/tokens.css`: 483593 raw bytes, 59105 gzip bytes.
