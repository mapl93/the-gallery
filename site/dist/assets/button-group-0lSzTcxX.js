import{j as e}from"./index-Dg0DyNZX.js";function h(t){const n={a:"a",code:"code",h2:"h2",li:"li",p:"p",ul:"ul",...t.components},{Callout:s,Do:i,DoDont:r,Dont:c,Preview:l,PropTable:d}=n;return s||o("Callout"),i||o("Do"),r||o("DoDont"),c||o("Dont"),l||o("Preview"),d||o("PropTable"),e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Overview"}),`
`,e.jsx(n.p,{children:"Groups multiple buttons with shared borders."}),`
`,e.jsx(l,{html:'<div class="btn-group"><button class="btn btn--outline">Left</button><button class="btn btn--outline">Center</button><button class="btn btn--outline">Right</button></div>',label:"Button Group"}),`
...
`,e.jsx(d,{children:e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(n.code,{children:".btn-group"})}),e.jsx("td",{children:"class"}),e.jsx("td",{children:"—"}),e.jsx("td",{children:"Base button group styles"})]})})]})}function a(t={}){const{wrapper:n}=t.components||{};return n?e.jsx(n,{...t,children:e.jsx(h,{...t})}):h(t)}function o(t,n){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}export{a as default};
