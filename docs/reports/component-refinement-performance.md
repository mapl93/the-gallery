...
| --- | --- | ---: | ---: | --- | --- |
| Complete neutral component CSS compatibility bundle | — | 580177 | 78134 | None | observed |
| Complete progressive-enhancement compatibility runtime | — | 118114 | 22912 | None | observed |
| Neutral web token target | — | 417971 | 51066 | None | observed |
...
| Largest dependency-closed Storytelling install slice | artist-card | 198228 | 27914 | None | observed |
...
| Surface | Largest component/asset | Raw bytes | Gzip bytes | Target rule | Result |
| --- | --- | ---: | ---: | --- | --- |
| Shopify theme token asset | — | 418131 | 51112 | None | observed |
| Largest Shopify local CSS asset (inventory, including compatibility files) | tokens.css | 418131 | 51112 | 100000 rawBytes; advisory | advisory-overage |
...
- `platforms/shopify/assets/tokens.css`: 418131 raw bytes, 51112 gzip bytes.
