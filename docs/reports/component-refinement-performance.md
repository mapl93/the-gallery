...
| --- | --- | ---: | ---: | --- | --- |
| Complete neutral component CSS compatibility bundle | — | 587291 | 78937 | None | observed |
| Complete progressive-enhancement compatibility runtime | — | 123453 | 24470 | None | observed |
| Neutral web token target | — | 498139 | 61128 | None | observed |
...
| Largest dependency-closed Product install slice | size-chart | 296360 | 39244 | None | observed |
| Largest dependency-closed Collection install slice | collection-grid | 218503 | 30974 | None | observed |
| Largest dependency-closed Storytelling install slice | artist-card | 201462 | 28082 | None | observed |
| Largest dependency-closed Marketing install slice | announcement-extended | 240741 | 37571 | None | observed |
| Largest dependency-closed Cart install slice | quick-view | 240709 | 35480 | None | observed |
...
| Largest dependency-closed Ceramics install slice | commission-form | 249256 | 34197 | None | observed |
...
| Surface | Largest component/asset | Raw bytes | Gzip bytes | Target rule | Result |
| --- | --- | ---: | ---: | --- | --- |
| Shopify theme token asset | — | 498299 | 61181 | None | observed |
| Largest Shopify local CSS asset (inventory, including compatibility files) | tokens.css | 498299 | 61181 | 100000 rawBytes; advisory | advisory-overage |
...
- `platforms/shopify/assets/tokens.css`: 498299 raw bytes, 61181 gzip bytes.
