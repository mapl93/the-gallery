...
- `docs/decisions/0312-native-choice-visual-customization.md` for Color Picker and Segmented Control public visual controls, native selection ownership, legend spacing and forced-color selection boundaries.
