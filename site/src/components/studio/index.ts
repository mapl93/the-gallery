...
import LocationStudio from './LocationStudio';
...
const studioRenderers: Record<string, ComponentType<StudioRendererProps>> = {
  ...
  'announcement-extended': GlobalStudio,
